...
type MQTTEventDecorator<T extends MQTTEventType> = (
  target: any,
 ...
 *
 * ## Usage
 * Apply `@MQTTEvent('<eventName>')` above a method. The method will be executed
